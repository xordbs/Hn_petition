  ...
  <div class="container">
    ...
    <div class="main_table">
      ...
      <%		
		...
		%>	
              <tr class="article" onclick="location.href='/admin/adminpost?adminId=<%=list.get(i).getAdminId()%>'">
                  <td><%=list.size()-i %></td>
                  <td><%=list.get(i).getTitle() %></td>
                  <td><%=list.get(i).getRegDate() %></td>
                  <td><%=list.get(i).getRegUser() %></td>
              </tr>
                                         <%		}
	}
	%>
...
%>
	...
	if(loginId != null && userName.equals("관리자")){
%>
            <div class="bo_list_btn">
                <a href="/admin/goadminWrite">공지사항 등록</a>
            </div>
    <%
	} 
%>
