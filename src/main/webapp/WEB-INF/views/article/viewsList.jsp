...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="/assets/css/ViewsList.css"/>
</head>
<body>
...
%>
  ...
  <div class="container">
    ...
    <!-- 게시판-->
	    <%
	List<Article> list = (List<Article>)request.getAttribute("articleViewsList");
	if(list != null) {
		%>				
      <table class="board1" width="100%">
          <caption class="bo_title">인기순 청원</caption>
          <colgroup>
              <col width="10%">
              <col width="50%">
              <col width="20%">
...
%>
  ...
  <div class="container">
	...
	if(list != null) {
		%>				
      <table class="board1" width="100%">
          <caption class="bo_title">인기된 청원</caption>
          <colgroup>
              <col width="10%">
              <col width="50%">
              <col width="20%">
