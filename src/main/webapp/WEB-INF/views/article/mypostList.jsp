...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="/assets/css/mypostList.css"/>
</head>
<body>
...
%>
  ...
  <div class="container">
    ...
    <!-- 게시판-->
	    <%
	List<Article> list = (List<Article>)request.getAttribute("articleMyPostList");
	if(list != null) {
		%>				
      <table class="board1" width="100%">
          <caption class="bo_title">내가 쓴 청원</caption>
          <colgroup>
              <col width="10%">
              <col width="50%">
              <col width="20%">
...
%>
	...
	if(loginId != null && userName.equals("")){
%>
    <a href="/admin/goWrite">청원 등록</a>
    <%
	} 
%>
